...
mkdir -p ${DISCOURSE_ROOT}/lib/plugin_manager/plugin
...
ln -sf ${PLUGIN_MANAGER_ROOT}/lib/plugin_manager/plugin/status.rb ${DISCOURSE_ROOT}/lib/plugin_manager/plugin/status.rb
